...
describe("V2PoolMintHandler", () => {
  ...
  it(`Should sum the pool token0 tvl with the amount passed in the event`, async () => {
    ...
    await handleV2PoolMint(context, pool, token0, token1, amount0, BigInt(0), eventTimestamp, poolSetters);
  ...
  it(`should sum the token0 pooled usd value by the amount passed in the event`, async () => {
    ...
    await handleV2PoolMint(context, pool, token0, token1, amount0InBigInt, BigInt(0), eventTimestamp, poolSetters);
  ...
  it(`should sum the token1 pooled usd value by the amount passed in the event`, async () => {
    ...
    await handleV2PoolMint(context, pool, token0, token1, BigInt(0), amount1InBigInt, eventTimestamp, poolSetters);
  ...
  it(`should deduct the pool token1 tvl with the amount passed in the event`, async () => {
    ...
    await handleV2PoolMint(context, pool, token0, token1, BigInt(0), amount1, eventTimestamp, poolSetters);
  ...
  it(`should update the pool usd tvl after summing the token amounts from the pool`, async () => {
    ...
    await handleV2PoolMint(context, pool, token0, token1, amount0, amount1, eventTimestamp, poolSetters);
