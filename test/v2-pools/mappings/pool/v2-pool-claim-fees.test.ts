...
describe("V2PoolClaimFeesHandler", () => {
  ...
  it(`Should deduct the pool token0 tvl with the amount passed in the event`, async () => {
    ...
    await handleV2PoolClaimFees(context, pool, token0, token1, amount0, BigInt(0), eventTimestamp, poolSetters);
  ...
  it(`should deduct the pool token1 tvl with the amount passed in the event`, async () => {
    ...
    await handleV2PoolClaimFees(context, pool, token0, token1, BigInt(0), amount1, eventTimestamp, poolSetters);
