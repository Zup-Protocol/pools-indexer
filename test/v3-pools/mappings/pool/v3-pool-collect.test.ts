...
describe("V3PoolCollectHandler", () => {
  ...
  it(`Should deduct the pool token0 tvl with the amount passed in the event`, async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, amount0, BigInt(0), eventTimestamp, poolSetters);
  ...
  it(`should deduct the token0 pooled usd value by the amount passed in the event`, async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, amount0OutBigInt, BigInt(0), eventTimestamp, poolSetters);
  ...
  it(`should deduct the token1 pooled usd value by the amount passed in the event`, async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, BigInt(0), amount1OutBigInt, eventTimestamp, poolSetters);
  ...
  it(`should deduct the pool token1 tvl with the amount passed in the event`, async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, BigInt(0), amount1, eventTimestamp, poolSetters);
  ...
  it(`should update the pool usd tvl after deducting the token amounts from the pool`, async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, amount0, amount1, eventTimestamp, poolSetters);
  ...
  it("should update the pool entity with the result from 'updatePoolAccumulatedYield'", async () => {
    ...
    await handleV3PoolCollect(context, pool, token0, token1, 0n, 0n, eventTimestamp, poolSetters);
    const updatedPool = await context.Pool.getOrThrow(pool.id)!;
