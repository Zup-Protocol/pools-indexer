...
import { AlgebraPool_1_2_1_Swap_event, AlgebraPoolData, Pool } from "generated";
...
describe("AlgebraPoolSwap", () => {
  ...
  let event: AlgebraPool_1_2_1_Swap_event;
  ...
  beforeEach(() => {
    ...
    event = AlgebraPool_1_2_1.Swap.createMockEvent({
  ...
  it("should pass override single swap fee to the v3 pool handler when the param overrideSwapFee is not 0", async () => {
  ...
  it("should not pass override single swap fee to the v3 pool handler when the param overrideSwapFee is 0", async () => {
