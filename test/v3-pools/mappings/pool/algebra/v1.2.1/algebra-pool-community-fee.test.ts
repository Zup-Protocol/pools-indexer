...
import { AlgebraPool_1_2_1_CommunityFee_event, AlgebraPoolData } from "generated";
import { AlgebraPool_1_2_1, MockDb } from "generated/src/TestHelpers.gen";
import { IndexerNetwork } from "../../../../../../src/common/enums/indexer-network";

describe("AlgebraPoolCommunityFee", () => {
  let mockDB = MockDb.createMockDb();
  let event: AlgebraPool_1_2_1_CommunityFee_event;
  ...
  beforeEach(() => {
    ...
    event = AlgebraPool_1_2_1.CommunityFee.createMockEvent({
      mockEventData: {
        chainId: chainId,
