...
import { AlgebraPool_1_2_1_TickSpacing_event, V3PoolData } from "generated";
...
describe("AlgebraPoolTickSpacing", () => {
  ...
  let event: AlgebraPool_1_2_1_TickSpacing_event;
  ...
  beforeEach(() => {
    ...
    event = AlgebraPool_1_2_1.TickSpacing.createMockEvent({
      mockEventData: {
        chainId: chainId,
