...
import { SushiSwapV3Factory_PoolCreated_event } from "generated";
import { MockDb, SushiSwapV3Factory } from "generated/src/TestHelpers.gen";
...
describe("SushiSwapV3Factory", () => {
  ...
  beforeEach(() => {
    ...
    event = SushiSwapV3Factory.PoolCreated.createMockEvent({
      ...
      tickSpacing: 9900n,
      fee: 121628710n,
      token0: "0x0000000000001000000000000000000000000002",
      token1: "0x0000000000000032000000000000000000000003",
    });
  });
  ...
  it("should pass the correct protocol when calling the pool created handler", async () => {
    ...
    assert.equal(passedProtocol, SupportedProtocol.SUSHI_SWAP_V3);
  });
